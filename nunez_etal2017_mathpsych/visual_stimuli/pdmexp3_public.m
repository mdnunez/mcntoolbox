...
%We used this MATLAB program in a visual decision making experiment for the
%two papers below. This program serves as examples of steady-state visual evoked
%potential (SSVEP) stimuli. See the two papers for a description of the
%experimental paradigm 
%
%We ran this on a Windows XP machine with Psychtoolbox 2 with a particular 
%setup for auditory experiments. Subjects used a Cedrus button box to give responses.
%http://psychtoolbox.org/
%http://cedrus.com/responsepads/rb530.htm
...
%  12/27/2015    Michael Nunez                  Public comments
...
%Load sounds
[ygood, Fsgood] = wavread('chimes.wav'); %Example sounds should be changed to different sound files
